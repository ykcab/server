  ...
  methods: {
    ...
    createGroup: function createGroup(gid) {
      ...
      this.$store.dispatch('addGroup', gid).then(function () {
        ...
        var userid = _this11.user.id;

        _this11.$store.dispatch('addUserGroup', {
          userid: userid,
          gid: gid
        });
      }).catch(function () {
    ...
    addUserGroup: function addUserGroup(group) {
      ...
      return this.$store.dispatch('addUserGroup', {
        ...
        return _this12.loading.groups = false;
      });
    },
    ...
    removeUserGroup: function removeUserGroup(group) {
      ...
      return this.$store.dispatch('removeUserGroup', {
        ...
        _this13.loading.groups = false; // remove user from current list if current list is the removed group

        if (_this13.$route.params.selectedGroup === gid) {
          _this13.$store.commit('deleteUser', userid);
        }
      }).catch(function () {
        _this13.loading.groups = false;
      });
    },
    ...
    removeUserSubAdmin: function removeUserSubAdmin(group) {
      ...
      return this.$store.dispatch('removeUserSubAdmin', {
        ...
        return _this15.loading.subadmins = false;
      });
    },
    ...
    setUserQuota: function setUserQuota() {
      ...
      this.$store.dispatch('setUserData', {
        ...
        return _this16.loading.quota = false;
      });
      return quota;
    },
    ...
    setUserLanguage: function setUserLanguage(lang) {
      ...
      this.$store.dispatch('setUserData', {
        ...
        return _this17.loading.languages = false;
      });
      return lang;
    },
    ...
    sendWelcomeMail: function sendWelcomeMail() {
      ...
      this.$store.dispatch('sendWelcomeMail', this.user.id).then(function (success) {
        if (success) {
          ...
          _this18.feedbackMessage = t('setting', 'Welcome mail sent!');
          setTimeout(function () {
            _this18.feedbackMessage = '';
          }, 2000);
        }

        _this18.loading.all = false;
      });
    }
  }
});
          ...
          _vm.showConfig.showStoragePath
            ? _c(
                "div",
                {
                  ...
                  attrs: { id: "theHeaderStorageLocation" }
                },
...
//# sourceMappingURL=vue-2.js.map?v=97910be741b4ce944a0b
